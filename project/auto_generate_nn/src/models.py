...
class CNN_48x4(nn.Module):
    def __init__(self, args):
        super(CNN_48x4, self).__init__()
        self.labels = args.number_of_labels
        self.batch_size = args.batch_size
        self.h1_size = 48
        self.h2_size = 48
        ...
        self.conv2 = nn.Conv2d(self.h1_size, self.h2_size, kernel_size=(5, 5), stride=(1, 1), padding=(2, 2),
                               bias=False)
        self.norm2 = nn.BatchNorm2d(self.h2_size, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.conv3 = nn.Conv2d(self.h2_size, self.h3_size, kernel_size=(5, 5), stride=(1, 1), padding=(2, 2),
                               bias=False)
        self.norm3 = nn.BatchNorm2d(self.h3_size, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.conv3 = nn.Conv2d(self.h2_size, self.h3_size, kernel_size=(5, 5), stride=(1, 1), padding=(2, 2),
                               bias=False)
        self.norm3 = nn.BatchNorm2d(self.h3_size, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.conv4 = nn.Conv2d(self.h2_size, self.h3_size, kernel_size=(5, 5), stride=(1, 1), padding=(2, 2),
                               bias=False)
        self.norm4 = nn.BatchNorm2d(self.h3_size, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
