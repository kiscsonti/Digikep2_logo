...
class V2_CNN(nn.Module):
    def __init__(self, labels, args):
        ...
        self.conv2 = nn.Conv2d(self.h1_size, self.h2_size, kernel_size=(5, 5), stride=(2, 2), padding=(2, 2), bias=False)
        self.norm2 = nn.BatchNorm2d(self.h2_size)

        self.conv3 = nn.Conv2d(self.h2_size, self.h3_size, kernel_size=(5, 5), stride=(2, 2), padding=(2, 2), bias=False)
